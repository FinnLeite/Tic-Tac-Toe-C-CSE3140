...
int main() {
	...
	cout << "\nPress any key, then press Enter to play...\n";
	char c;
	cin >> c;
start:
	refreshPage();
	...
	else if ((checkWinner() != 0) && (checkWinner() != player)) { //Check if computer won
		cout << endl;
		cout << "***********************************\n";
		cout << "* Game over! The winner is Computer!    *\n";
		cout << "***********************************\n";
		cout << "\nPress any key, then press Enter to play...\n";
		char c;
		cin >> c;
...
secround:
	...
	//printBoard();
	//**********************************************
	if (checkWinner() == 10) { //Check if it's a tie
		cout << endl;
		cout << "***********************************\n";
		cout << "* Game over! It is a tie!         *\n";
		cout << "***********************************\n";
	...
	else if ((checkWinner() != 0) && (checkWinner() != player)) { //Check if coumputer won
		cout << endl;
		cout << "***********************************\n";
		cout << "* Game over! The winner is Computer!    *\n";
		cout << "***********************************\n";
...
void printBoard() { //Tic tac toe board
	char displayBoard[9] = { ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ', ' ' };
	for (int i = 0; i < 9; i++) {
		switch (board[i]) {
		case 0:
